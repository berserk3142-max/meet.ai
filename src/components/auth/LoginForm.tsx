        ...
        <div>
            ...
            <div className="space-y-3 mb-6">
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 rounded-lg border border-zinc-600 bg-zinc-700/50 py-2.5 text-white transition-all hover:bg-zinc-600/50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="bg-zinc-800/50 px-4 text-zinc-400">or continue with email</span>
                </div>
            </div>
